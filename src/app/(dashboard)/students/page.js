  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Drawer
        ...
        title={editingStudent ? 'Edit Student Profile' : 'New Student Admission'}
        subtitle="Fill in mandatory details for official school records"
        icon={GraduationCap}
        maxWidth="max-w-2xl"
        footer={
          <div className="flex items-center justify-end space-x-3">
            ...
            >
              {editingStudent ? 'Update Student' : 'Save Admission'}
            </Button>
          </div>
        }
      >
