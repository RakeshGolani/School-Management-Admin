...
export default function BackendOfflineScreen() {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-950/90 backdrop-blur-xl animate-fadeIn text-slate-100">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-amber-500/10 rounded-full blur-3xl pointer-events-none animate-pulse" />
      ...
      <div className="relative w-full max-w-md bg-slate-900/95 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden p-6 sm:p-8 text-center space-y-6 backdrop-blur-2xl">
        ...
        <div className="relative flex justify-center items-center py-2">
          ...
          <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-tr from-amber-500 to-rose-600 flex items-center justify-center shadow-xl shadow-rose-500/20 text-white">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-300 leading-relaxed">
            The SuperAdmin console is unable to reach the master backend server. Please verify network and server status.
          </p>
        </div>
        ...
        <div className="space-y-3 pt-1">
          <button
            ...
            disabled={isSpinning}
            className="w-full inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl font-bold text-slate-950 bg-gradient-to-r from-amber-400 via-amber-500 to-rose-500 hover:from-amber-300 hover:to-rose-400 active:scale-[0.98] transition-all shadow-lg shadow-amber-500/20 disabled:opacity-75 disabled:cursor-not-allowed cursor-pointer text-sm"
          >
